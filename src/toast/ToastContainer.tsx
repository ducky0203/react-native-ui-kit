...
const defaultComponents: ToastConfig = {
  ...
  base: (props: ToastConfigParams) => (
    <BaseToast {...props} onClose={props.hide} />
  ),
};
...
export const ToastContainer: React.FC<ToastContainerProps> = ({
  ...
  const autoHideTimersRef = useRef<Map<string, ReturnType<typeof setTimeout>>>(
    new Map()
  );
          ...
          style={[
            ...
            defaultPosition === 'top'
              ? {
                  top:
                    topOffset +
                    visibleToasts.length * ANIMATION_CONFIG.expandedHeight +
                    10,
                }
              : {
                  bottom:
